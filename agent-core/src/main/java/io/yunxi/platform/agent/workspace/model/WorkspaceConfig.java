package io.yunxi.platform.agent.workspace.model;
 ...
 * 由 {@link io.yunxi.platform.agent.workspace.WorkspaceAutoDiscoveryEngine} 在启动时自动扫描生成。</p>
 *
...
public class WorkspaceConfig {
    ...
    public SceneDetectionRule getSceneRule() { return sceneRule; }
    public void setSceneRule(SceneDetectionRule sceneRule) { this.sceneRule = sceneRule; }
    public List<String> getKnowledgeFiles() { return knowledgeFiles; }
    public void setKnowledgeFiles(List<String> knowledgeFiles) { this.knowledgeFiles = knowledgeFiles; }
