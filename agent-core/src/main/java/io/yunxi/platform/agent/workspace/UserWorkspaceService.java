 ...
 * {@code workspaceBasePath}/agents/{agentName}/users/{userId}/}。
 * </p>
 *
 * <p>
 * <b>路由逻辑</b>：
 ...
 * 的用户版</li>
 * <li>workspace 路径 =
 * {@code .agentscope/workspace/agents/food-chat/users/zhangsan/}</li>
 * </ul>
 * </p>
 *
...
public class UserWorkspaceService {
     ...
     * @return Agent 实例，workspace 路径为 agents/{agentName}/users/{userId}/
    ...
    public Agent getOrCreateUserAgent(String agentName, String userId) {
        ...
        synchronized (compositeKey.intern()) {
            ...
            // 构建用户专属工作空间路径：框架设计为 agent 优先 → agents/{agentName}/users/{userId}/
            String workspacePath = coreProperties.getWorkspaceBasePath()
                    + "/agents/" + agentName + "/users/" + userId;
