...
public class MemorySceneRegistry {
     ...
     * 注册自定义场景
     * <p>
     * 业务层在初始化时调用此方法动态注册场景（如校园餐场景 SCHOOL_MEAL）。
     ...
     * 返回第一个匹配的场景名称，未匹配时回退到 {@link MemoryScene#GENERAL}。
     * 关键词匹配大小写不敏感。
     * </p>
     *
     * @param text 用户输入文本
